...
const FULL_MATCHES: MatchWithHC[] = [
  { id: 'm-1', date: '18/07', time: '00:15', league: 'NORWAY ELITESERIEN', flag: 'no', homeTeam: '[3] Bodo Glimt', awayTeam: '[9] Fredrikstad', handicap: '0 : 2 1/4', predictedScore: '0 - 2' },
  { id: 'm-2', date: '18/07', time: '00:00', league: 'SWEDEN ALLSVENSKAN', flag: 'se', homeTeam: '[14] IFK Goteborg', awayTeam: '[11] Brommapojkarna', handicap: '0 : 1/2', predictedScore: '2 - 1' },
  { id: 'm-3', date: '18/07', time: '00:00', league: 'SWEDEN ALLSVENSKAN', flag: 'se', homeTeam: '[10] Mjallby', awayTeam: '[8] Vasteras SK', handicap: '0 : 3/4', predictedScore: '3 - 0' },
  { id: 'm-4', date: '17/07', time: '18:00', league: 'CHINA FOOTBALL SUPER LEAGUE', flag: 'cn', homeTeam: '[6] Qingdao West Coast FC', awayTeam: '[1] Chengdu Rongcheng', handicap: '3/4 : 0', predictedScore: '1 - 2' },
  { id: 'm-5', date: '17/07', time: '18:35', league: 'CHINA FOOTBALL SUPER LEAGUE', flag: 'cn', homeTeam: '[7] Beijing Guoan', awayTeam: '[9] Liaoning Tieren', handicap: '0 : 1 1/4', predictedScore: '2 - 0' },
  { id: 'm-6', date: '17/07', time: '18:35', league: 'CHINA FOOTBALL SUPER LEAGUE', flag: 'cn', homeTeam: '[13] Henan FC', awayTeam: '[14] Qingdao Hainiu', handicap: '0 : 1 1/2', predictedScore: '1 - 1' },
  { id: 'm-7', date: '17/07', time: '19:00', league: 'CHINA FOOTBALL SUPER LEAGUE', flag: 'cn', homeTeam: '[5] Yunnan Yukun', awayTeam: '[12] Shanghai Port FC', handicap: '1/4 : 0', predictedScore: '3 - 2' },
  { id: 'm-8', date: '17/07', time: '19:00', league: 'CHINA FOOTBALL SUPER LEAGUE', flag: 'cn', homeTeam: '[5] Yunnan Yukun', awayTeam: '[12] Shanghai Port FC', handicap: '0 : 1/4', predictedScore: '0 - 1' },
  { id: 'm-9', date: '17/07', time: '16:30', league: 'AUSTRALIA VICTORIA NATIONAL PREMIER LEAGUE', flag: 'au', homeTeam: '[14] Green Gully Cavaliers', awayTeam: '[13] Dandenong Thunder', handicap: '0 : 3/4', predictedScore: '1 - 2' },
  { id: 'm-10', date: '17/07', time: '16:30', league: 'AUSTRALIA VICTORIA NATIONAL PREMIER LEAGUE', flag: 'au', homeTeam: '[12] Bentleigh Greens', awayTeam: '[10] Dandenong City SC', handicap: '1/2 : 0', predictedScore: '2 - 2' },
  { id: 'm-11', date: '17/07', time: '23:00', league: 'FINLAND YKKOSLIIGA', flag: 'fi', homeTeam: '[9] Klubi 04 Helsinki', awayTeam: '[5] Haka', handicap: '1 : 0', predictedScore: '1 - 0' },
  { id: 'm-12', date: '17/07', time: '23:00', league: 'FINLAND YKKOSLIIGA', flag: 'fi', homeTeam: '[8] KaPa Helsinki', awayTeam: '[10] Seinajoen JK Akatemia', handicap: '0 : 1/4', predictedScore: '2 - 1' },
  { id: 'm-13', date: '17/07', time: '22:30', league: 'ROMANIA SUPERLIGA', flag: 'ro', homeTeam: 'FC Voluntari', awayTeam: 'Botosani', handicap: '0 : 0', predictedScore: '1 - 1' },
  { id: 'm-14', date: '18/07', time: '01:30', league: 'ROMANIA SUPERLIGA', flag: 'ro', homeTeam: 'FCSB', awayTeam: 'FC Arges', handicap: '0 : 3/4', predictedScore: '2 - 0' },
  { id: 'm-15', date: '17/07', time: '16:30', league: 'AUSTRALIA NEW SOUTH WALES PREMIER LEAGUE', flag: 'au', homeTeam: '[6] Sydney FC [Youth]', awayTeam: '[9] Manly United', handicap: '0 : 0', predictedScore: '3 - 1' },
  { id: 'm-16', date: '17/07', time: '16:30', league: 'SOUTH AUSTRALIA NATIONAL PREMIER LEAGUE', flag: 'au', homeTeam: '[9] Campbelltown City', awayTeam: '[11] Adelaide Comets', handicap: '0 : 3/4', predictedScore: '2 - 1' },
  { id: 'm-17', date: '17/07', time: '23:00', league: 'BULGARIA FIRST PROFESSIONAL FOOTBALL LEAGUE', flag: 'bg', homeTeam: 'Spartak Varna', awayTeam: 'FC CSKA 1948 Sofia', handicap: '3/4 : 0', predictedScore: '0 - 2' },
  { id: 'm-18', date: '18/07', time: '01:15', league: 'BULGARIA FIRST PROFESSIONAL FOOTBALL LEAGUE', flag: 'bg', homeTeam: 'Levski Sofia', awayTeam: 'Dunav Ruse FC', handicap: '0 : 2 1/4', predictedScore: '3 - 0' },
  { id: 'm-19', date: '18/07', time: '02:15', league: 'ICELAND 1ST DIV', flag: 'is', homeTeam: '[2] Fylkir', awayTeam: '[6] UMF Njardvik', handicap: '0 : 1/2', predictedScore: '2 - 1' },
  { id: 'm-20', date: '17/07', time: '18:00', league: 'WESTERN AUSTRALIA NATIONAL PREMIER LEAGUE', flag: 'au', homeTeam: '[4] Perth Azzurri', awayTeam: '[7] Western Knights', handicap: '0 : 1/2', predictedScore: '1 - 0' },
  { id: 'm-21', date: '17/07', time: '23:00', league: 'SLOVENIA PRVA LIGA', flag: 'si', homeTeam: 'NK Nafta 1903', awayTeam: 'FC Koper', handicap: '1 : 0', predictedScore: '1 - 2' },
  { id: 'm-22', date: '18/07', time: '01:15', league: 'SLOVENIA PRVA LIGA', flag: 'si', homeTeam: 'NK Celje', awayTeam: 'NS Mura', handicap: '0 : 1 1/2', predictedScore: '3 - 1' },
  { id: 'm-23', date: '17/07', time: '18:00', league: 'AUSTRALIA NORTHERN TERRITORY PREMIER LEAGUE', flag: 'au', homeTeam: 'Darwin Olympic', awayTeam: 'Palmerston Rovers FC', handicap: '0 : 2', predictedScore: '2 - 0' },
  { id: 'm-24', date: '17/07', time: '17:30', league: 'AUSTRALIA VICTORIA PREMIER LEAGUE 1', flag: 'au', homeTeam: 'Northcote City', awayTeam: 'Manningham United Blues FC', handicap: '0 : 3/4', predictedScore: '1 - 3' },
  { id: 'm-25', date: '17/07', time: '17:30', league: 'AUSTRALIA VICTORIA PREMIER LEAGUE 1', flag: 'au', homeTeam: 'Melbourne Knights', awayTeam: 'Brunswick City SC', handicap: '0 : 1 1/4', predictedScore: '2 - 1' },
  { id: 'm-26', date: '17/07', time: '17:00', league: 'AUSTRALIA FOOTBALL NEW SOUTH WALES LEAGUE 1', flag: 'au', homeTeam: 'Prospect United FC', awayTeam: 'Macarthur Rams', handicap: '1/4 : 0', predictedScore: '1 - 0' },
  { id: 'm-27', date: '17/07', time: '17:00', league: 'AUSTRALIA FOOTBALL NEW SOUTH WALES LEAGUE 1', flag: 'au', homeTeam: 'Hurstville Zagreb FC', awayTeam: 'Dulwich Hill', handicap: '0 : 1/2', predictedScore: '0 - 2' },
  { id: 'm-28', date: '17/07', time: '23:00', league: 'ESTONIA PREMIUM LIGA', flag: 'ee', homeTeam: 'Flora Tallinn', awayTeam: 'FC Nomme United', handicap: '0 : 1 3/4', predictedScore: '3 - 0' },
  { id: 'm-29', date: '18/07', time: '07:10', league: 'USA MAJOR LEAGUE SOCCER', flag: 'us', homeTeam: 'Nashville SC', awayTeam: 'Atlanta United FC', handicap: '0 : 1 1/4', predictedScore: '2 - 1' },
  { id: 'm-30', date: '18/07', time: '09:25', league: 'USA MAJOR LEAGUE SOCCER', flag: 'us', homeTeam: 'L.A Galaxy', awayTeam: 'Los Angeles FC', handicap: '1/4 : 0', predictedScore: '1 - 2' },
  { id: 'm-31', date: '18/07', time: '05:30', league: 'BRAZIL SERIE A', flag: 'br', homeTeam: '[6] Bahia EC BA', awayTeam: '[20] Chapecoense SC', handicap: '0 : 1 1/4', predictedScore: '2 - 0' },
  { id: 'm-32', date: '18/07', time: '06:00', league: 'BRAZIL SERIE A', flag: 'br', homeTeam: '[19] Mirassol SP', awayTeam: '[16] Gremio Porto Alegrense', handicap: '0 : 1/2', predictedScore: '1 - 1' },
  { id: 'm-33', date: '18/07', time: '06:00', league: 'BRAZIL SERIE A', flag: 'br', homeTeam: '[3] Fluminense RJ', awayTeam: '[5] Red Bull Bragantino SP', handicap: '0 : 1/2', predictedScore: '3 - 2' },
  { id: 'm-34', date: '18/07', time: '08:00', league: 'MEXICO PRIMERA DIVISION', flag: 'mx', homeTeam: 'Atletico San Luis', awayTeam: 'Cruz Azul', handicap: '1/2 : 0', predictedScore: '1 - 2' },
  { id: 'm-35', date: '18/07', time: '08:00', league: 'MEXICO PRIMERA DIVISION', flag: 'mx', homeTeam: 'Club Leon', awayTeam: 'Atlas', handicap: '0 : 1/2', predictedScore: '2 - 1' },
  { id: 'm-36', date: '18/07', time: '10:00', league: 'MEXICO PRIMERA DIVISION', flag: 'mx', homeTeam: 'FC Juarez', awayTeam: 'Puebla FC', handicap: '0 : 3/4', predictedScore: '3 - 1' },
  { id: 'm-37', date: '18/07', time: '04:45', league: 'ARGENTINA CUP', flag: 'ar', homeTeam: 'San Lorenzo [n]', awayTeam: 'Deportivo Riestra', handicap: '0 : 1/4', predictedScore: '1 - 0' },
  { id: 'm-38', date: '18/07', time: '07:45', league: 'ARGENTINA CUP', flag: 'ar', homeTeam: 'CA River Plate [n]', awayTeam: 'Aldosivi', handicap: '0 : 1 1/4', predictedScore: '3 - 1' },
  { id: 'm-39', date: '18/07', time: '05:00', league: 'BRAZIL SERIE B', flag: 'br', homeTeam: '[5] Juventude RS', awayTeam: '[11] Cuiaba MT', handicap: '0 : 1/4', predictedScore: '2 - 1' },
  { id: 'm-40', date: '18/07', time: '05:00', league: 'BRAZIL SERIE B', flag: 'br', homeTeam: '[7] Sao Bernardo SP', awayTeam: '[18] Avai SC', handicap: '0 : 1/2', predictedScore: '1 - 0' },
  { id: 'm-41', date: '18/07', time: '05:00', league: 'BRAZIL SERIE B', flag: 'br', homeTeam: '[20] America Mineiro', awayTeam: '[17] Ceara CE', handicap: '0 : 0', predictedScore: '2 - 2' },
  { id: 'm-42', date: '18/07', time: '07:00', league: 'BRAZIL SERIE B', flag: 'br', homeTeam: '[6] Fortaleza CE', awayTeam: '[4] Gremio Novorizontino SP', handicap: '0 : 1/2', predictedScore: '3 - 2' },
  { id: 'm-43', date: '18/07', time: '07:00', league: 'BRAZIL SERIE B', flag: 'br', homeTeam: '[16] Londrina PR', awayTeam: '[14] Botafogo SP', handicap: '0 : 1/4', predictedScore: '1 - 1' },
  { id: 'm-44', date: '18/07', time: '07:00', league: 'ECUADOR LIGA PRO SERIE A', flag: 'ec', homeTeam: '[15] Delfin SC', awayTeam: '[5] Macara', handicap: '0 : 0', predictedScore: '0 - 1' },
  { id: 'm-45', date: '18/07', time: '07:00', league: 'BOLIVIA PROFESSIONAL FOOTBALL LEAGUE', flag: 'bo', homeTeam: 'Bolivar', awayTeam: 'Club Deportivo Guabira', handicap: '0 : 2', predictedScore: '3 - 0' },
  { id: 'm-46', date: '18/07', time: '01:00', league: 'PERU LIGA 1', flag: 'pe', homeTeam: 'FC Cajamarca', awayTeam: 'Juan Pablo II College', handicap: '0 : 1/2', predictedScore: '1 - 0' },
  { id: 'm-47', date: '18/07', time: '03:15', league: 'PERU LIGA 1', flag: 'pe', homeTeam: 'Sporting Cristal', awayTeam: 'Deportivo Garcilaso', handicap: '0 : 1 1/4', predictedScore: '2 - 1' },
  { id: 'm-48', date: '18/07', time: '08:00', league: 'PERU LIGA 1', flag: 'pe', homeTeam: 'Cienciano', awayTeam: 'FBC Melgar', handicap: '0 : 1/2', predictedScore: '1 - 2' },
  { id: 'm-49', date: '18/07', time: '01:00', league: 'URUGUAY TORNEO INTERMEDIO', flag: 'uy', homeTeam: 'Albion FC', awayTeam: 'CA Juventud', handicap: '0 : 1/4', predictedScore: '0 - 1' },
  { id: 'm-50', date: '18/07', time: '05:30', league: 'URUGUAY TORNEO INTERMEDIO', flag: 'uy', homeTeam: 'Nacional Montevideo', awayTeam: 'Montevideo Wanderers', handicap: '0 : 3/4', predictedScore: '2 - 0' },
  { id: 'm-51', date: '18/07', time: '01:00', league: 'ARGENTINA PRIMERA NACIONAL', flag: 'ar', homeTeam: 'Deportivo Maipu', awayTeam: 'San Martin Tucuman', handicap: '0 : 0', predictedScore: '1 - 1' },
  { id: 'm-52', date: '18/07', time: '01:00', league: 'ARGENTINA PRIMERA NACIONAL', flag: 'ar', homeTeam: 'Almirante Brown', awayTeam: 'CA Estudiantes De Caseros', handicap: '0 : 0', predictedScore: '0 - 0' },
  { id: 'm-53', date: '18/07', time: '02:00', league: 'ARGENTINA PRIMERA NACIONAL', flag: 'ar', homeTeam: 'Club Atletico Mitre', awayTeam: 'CA Racing Cordoba', handicap: '0 : 1/4', predictedScore: '2 - 1' },
  { id: 'm-54', date: '18/07', time: '04:00', league: 'ARGENTINA PRIMERA NACIONAL', flag: 'ar', homeTeam: 'Nueva Chicago', awayTeam: 'Club Agropecuario Argentino', handicap: '0 : 1/4', predictedScore: '1 - 0' },
  { id: 'm-55', date: '18/07', time: '05:30', league: 'ARGENTINA PRIMERA NACIONAL', flag: 'ar', homeTeam: 'Ferro Carril Oeste', awayTeam: 'Colon de Santa Fe', handicap: '0 : 1/4', predictedScore: '2 - 2' },
  { id: 'm-56', date: '18/07', time: '06:00', league: 'ARGENTINA PRIMERA NACIONAL', flag: 'ar', homeTeam: 'Club Ciudad de Bolivar', awayTeam: 'CA All Boys', handicap: '0 : 1/4', predictedScore: '3 - 1' },
  { id: 'm-57', date: '18/07', time: '06:30', league: 'ARGENTINA PRIMERA NACIONAL', flag: 'ar', homeTeam: 'CA Temperley', awayTeam: 'Atletico de Rafaela', handicap: '0 : 1/2', predictedScore: '2 - 0' },
  { id: 'm-58', date: '18/07', time: '04:30', league: 'ECUADOR LIGA PRO SERIE B', flag: 'ec', homeTeam: '[9] LDU Portoviejo', awayTeam: '[4] CD Independiente Juniors', handicap: '0 : 0', predictedScore: '1 - 1' },
  { id: 'm-59', date: '18/07', time: '06:00', league: 'CANADIAN PREMIER LEAGUE', flag: 'ca', homeTeam: '[7] FC Supra du Quebec', awayTeam: '[5] Vancouver FC', handicap: '0 : 0', predictedScore: '2 - 1' }
];
